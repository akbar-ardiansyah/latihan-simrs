 ...
 * 
            public function ...(){
            $this->load->library('Datatable');   // load di dalam function atau di construct
            $this->datatable->select("....");
            $this->datatable->from("....);
            $this->datatable->join("....');
            $this->datatable->order_by("field", "desc", 'left');
            $this->datatable->edit_column('....', '....', '....');
             echo $this->datatable->generate();
            }

 * dan masih banyak fungsi lainnya yang dapat digunakan di bawah
 */
class Datatable
{
